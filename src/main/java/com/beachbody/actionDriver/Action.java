package com.beachbody.actionDriver;

import com.beachbody.ActionInterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface
{
     ...
     *
     * @paramlocator     : Action to be performed on element (Get it from Object
     *                    repository)
     *
     * @param index       : Index of value wish to select from dropdown list.
     *
     * @paramlocatorName : Meaningful name to the element (Ex:Year Dropdown, items
     *                    Listbox etc..)
     *
     */
    @Override
